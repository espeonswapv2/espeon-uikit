...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 228 228" }, props),
        React.createElement("image", { width: "228", height: "228", href: "/images/egg/logo.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 228 228" }, props),
        React.createElement("image", { width: "228", height: "228", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
