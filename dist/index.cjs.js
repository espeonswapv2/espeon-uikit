...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 228 228" }, props),
        React__default['default'].createElement("image", { width: "228", height: "228", href: "/images/egg/logo.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 228 228" }, props),
        React__default['default'].createElement("image", { width: "228", height: "228", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Accordion = function (_a) {
    var label = _a.label, status = _a.status, icon = _a.icon, isPushed = _a.isPushed, pushNav = _a.pushNav, _b = _a.initialOpenState, initialOpenState = _b === void 0 ? false : _b, children = _a.children, className = _a.className;
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
